...
export const paymentOptions: CheckoutPaymentOption[] = [
  ...
  },
  {
    ...
    description: "Pay securely with Visa, Mastercard, AMEX, or wallets",
    emoji: "💳",
    badge: "Available now",
  },
  {
    id: "payment-bkash",
    value: "bkash",
    title: "bKash Mobile Money",
    description: "Sandbox MFS payment via direct bKash popup",
    emoji: "🌸",
    badge: "Coming soon",
  },
  {
    ...
    value: "nagad",
    title: "Nagad Wallet",
    description: "Sandbox MFS payment via direct Nagad gateway",
    emoji: "🍊",
    badge: "Coming soon",
  },
]
