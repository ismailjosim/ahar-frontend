...
const categorySchema = z.object({
  name: z
    .string({
      error: (issue) => (issue.input === undefined ? "Category name is required" : "Category name must be a string"),
    })
    .trim()
    .min(2, {
...
export const createCategoryZodSchema = categorySchema

export const updateCategoryZodSchema = categorySchema
