...
export async function createCategory(_prevState: any, formData: FormData) {
  try {
    ...
    const validation = zodValidator(payload, createCategoryZodSchema)
...
export async function updateCategory(id: string, _prevState: any, formData: FormData) {
  try {
    ...
    const validation = zodValidator(payload, updateCategoryZodSchema)
...
export async function softDeleteCategory(id: string) {
  try {
    const res = await serverFetch.delete(`/category/soft/${id}`)
