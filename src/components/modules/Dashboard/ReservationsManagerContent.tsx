                ...
                <tr key={r.id} className="border-b">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2">
                      {r.status === "Pending" && (
                        <button onClick={() => approve(r.id)} className="rounded px-2 py-1 text-xs bg-green-100">
                          Approve
                        </button>
                      )}
                      ...
                      <button onClick={() => remove(r.id)} className="rounded px-2 py-1 text-xs border text-red-600">
                        Delete
                      </button>
                    </div>
                  </td>
