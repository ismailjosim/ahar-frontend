...
export default function ReportsManagerContent() {
  ...
  return (
    <div className="space-y-4">
      <div className="rounded-lg border border-[#F3E5D8] bg-white p-6 dark:border-slate-700 dark:bg-slate-800">
        ...
        <div className="mt-4 flex flex-wrap gap-3">
          <button onClick={() => download("orders")} className="rounded-md bg-[#B22222] px-4 py-2 text-white">
            Export Orders
          </button>
