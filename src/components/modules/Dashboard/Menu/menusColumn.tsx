...
import { ArchiveX, Eye, MoreHorizontal, Pencil, Trash2 } from "lucide-react"
...
export const menuColumns = ({ onEdit, onView, onDelete, onRefresh }: MenuColumnsOptions): ColumnDef<MenuItem>[] => [
  // ── Image ───────────────────────────────────────────────────────────
  {
    id: "image",
    header: "Image",
  ...
  // ── Category ────────────────────────────────────────────────────────
  {
    ...
    cell: ({ row }) => {
      ...
      return <span className="text-sm font-medium text-muted-foreground">{category || "N/A"}</span>
    },
  },
  ...
  // ── Price ──────────────────────────────────────────────────────────
  {
    accessorKey: "price",
    header: "Price",
    cell: ({ row }) => <span className="text-sm font-semibold text-primary">{formatCurrency(row.original.price)}</span>,
  },
