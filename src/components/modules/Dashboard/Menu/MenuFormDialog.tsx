            ...
            <section className="space-y-5">
              ...
              <section className="space-y-5">
                <div className="grid gap-3 md:grid-cols-4 items-start">
                  ...
                  {/* checkbox for isAvailable, isFeatured, isSpicy */}
                  <div className="col-span-2 gap-2 flex">
                    <label className="flex items-center gap-3 rounded-lg border p-2 cursor-pointer hover:bg-muted/50">
                      <input
                        type="checkbox"
                        name="isAvailable"
                        value="true"
              ...
              <section className="grid sm:grid-cols-2 items-start gap-4">
