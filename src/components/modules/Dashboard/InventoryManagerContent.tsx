  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        ...
        <aside className="rounded-lg border border-border bg-card p-4 dark:border-slate-700 dark:bg-slate-800">
          ...
          <div className="mt-3 space-y-2">
            {low.length === 0 ? (
              ...
              low.map((l, idx) => (
                <div
                  key={idx}
                  className={`rounded p-2 ${l.severity === "critical" ? "bg-(--destructive)/10 text-destructive" : "bg-(--warning)/10 text-warning-foreground"}`}
                >
